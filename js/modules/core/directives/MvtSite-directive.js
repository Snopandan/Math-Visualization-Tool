CoreModule.directive('mvtSite', ['MultiTransclude', function(MultiTransclude) {
  return {
    ...
    template: '<div transclude-id="main"></div>'+
              ...
              '<a ng-href="#/schematic/"><div ng-href="/pattern" title="Create a new visualization" class="gui circle button add"><img class="buttonImage" src="images/icons/add.png" /></div></a>' +
